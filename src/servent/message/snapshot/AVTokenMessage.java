...
public class AVTokenMessage extends BasicMessage {
    ...
    public AVTokenMessage(ServentInfo sender, ServentInfo reciever, int collectorId,
                          Map<Integer, Integer> senderVectorClock){
        super(MessageType.AV_TOKEN, sender, reciever, String.valueOf(collectorId));
        this.senderVectorClock = senderVectorClock;
    }

    private AVTokenMessage(MessageType messageType, ServentInfo sender, ServentInfo reciever,
    ...
    public Message makeMeASender() {
        ...
        Message toReturn = new AVTokenMessage(getMessageType(), getOriginalSenderInfo(), getReceiverInfo(),
    ...
    public Message changeReceiver(Integer newReceiverId) {
        if(AppConfig.myServentInfo.getNeighbors().contains(newReceiverId)){
            ...
            Message toReturn = new AVTokenMessage(getMessageType(), getOriginalSenderInfo(), newRecieverInfo,
